package PDASimulator.DecidableTuringMachine;
...
public class DecidableTuringMachine {
    public static final String initialStackSymbol = "$";
    public static final TransitionInfo defaultTransition = new TransitionInfo(
    ...
    @JsonCreator
    public static DecidableTuringMachine fromJSON_YAML(
